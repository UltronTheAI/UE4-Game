...
if [ -f "D:\ue4.2\Unreal_Engine_4.19.0_Master_Source_and_Compiled\UE_4.19\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\ue4.2\Unreal_Engine_4.19.0_Master_Source_and_Compiled\UE_4.19\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
